...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { artist: @promotion.artist, message: @promotion.message, name: @promotion.name, promoter: @promotion.promoter }
    end
  ...
  test "should update promotion" do
    put :update, id: @promotion, promotion: { artist: @promotion.artist, message: @promotion.message, name: @promotion.name, promoter: @promotion.promoter }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
